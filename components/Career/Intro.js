    ...
    <>
      ...
      <section className="vm-careers bg-white pt-10 pb-24 overflow-hidden">
        <div className="px-5 sm:px-8 text-center">
          <h1 className="vm-display text-[1.4rem] sm:text-[2.2rem] leading-[1.1] font-extrabold text-gray-900 mb-8 vm-fade-up-1">
            <span className="vm-underline-anim text-[#E8001C]">Careers</span>
          </h1>

          <div className="text-left space-y-6">
            <p className="text-gray-700 text-[12px] sm:text-[14px] font-semibold vm-fade-up-2">
              Welcome!
              <br />
              <span className="text-gray-500 text-[12px] sm:text-[14px] font-normal">
                We&apos;re delighted that you are interested in a career at{" "}
                <span className="text-gray-900 font-bold">ValueMax Cash &amp; Carry</span>.
              </span>
            </p>

            <p className="text-gray-500 text-[12px] sm:text-[14px] leading-relaxed vm-fade-up-3">
          ...
          {!openForm && (
            <div className="flex justify-center mt-10 vm-fade-up-5">
              <button
                className="vm-btn-hover bg-[#b60a01] hover:bg-[#c0001a] text-white font-bold text-sm px-6 py-2 rounded-xl border-none cursor-pointer uppercase tracking-wide"
                onClick={() => {
                  setOpenForm(true);
                }}
              >
