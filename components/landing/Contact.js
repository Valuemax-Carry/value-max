...
const CONTACT_CARDS = [
  ...
  },
  {
    ...
    label: "Visit Us",
    value:
      "Islam Plaza, Main Bazar, Chak Beli Khan, Postal Code 47600, Tehsil & District Rawalpindi",
  },
];
...
export default function Contact() {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className="vm-contact relative bg-[#ffffff] overflow-hidden mt-20"
        id="contact"
      >
        <div
          className="absolute top-0 left-0 w-[40%] h-full bg-[#ffffff] hidden lg:block"
          style={{ clipPath: "polygon(0 0, 88% 0, 76% 100%, 0% 100%)" }}
        />

        <div className="absolute top-10 left-[6%] w-20 h-20 bg-[#ffbc0b] rounded-full opacity-15 vm-c-badge-float hidden lg:block" />
        <div
          className="absolute bottom-16 left-[18%] w-10 h-10 bg-[#b60a01] rounded-full opacity-10 vm-c-badge-float hidden lg:block"
          ...
          <div className="relative z-10 max-w-[480px]">
            ...
            {visible && (
              <h2 className="vm-contact-display vm-c-up-2 text-[2.4rem] sm:text-[3rem] lg:text-[3.4rem] leading-[1.1] font-extrabold text-gray-900 mb-5">
                ...
                <span className="vm-c-underline text-[#E8001C]">
                  Wholesale Prices
                </span>
                ?
              </h2>
            ...
            {visible && (
              <p className="vm-c-up-3 text-gray-500 text-base sm:text-lg leading-relaxed mb-8">
                Whether you're shopping for fresh groceries, household
                essentials, or stocking up for your business, we're here to
                provide quality products at great prices with exceptional
                service.
              </p>
            )}
          ...
          <div className="relative z-10 w-full lg:w-auto flex flex-col gap-4">
            {CONTACT_CARDS.map((c, i) => (
              ...
              >
                ...
                <div>
                  <div className="text-[11px] uppercase tracking-widest text-gray-400 font-semibold mb-0.5">
                    {c.label}
                  </div>
                  <div className="text-gray-900 text-[15px] font-semibold leading-snug">
                    {c.value}
                  </div>
                </div>
              </div>
            ...
            {visible && (
              <div className="vm-c-up-4 flex items-center gap-2 mt-2 bg-white border border-gray-100 rounded-full px-4 py-2 shadow-sm self-start">
                ...
                <span className="text-[12px] text-gray-500 font-medium">
                  A project of ASHRAF & SONS TRADERS (SMC-PVT) LTD.
                </span>
              </div>
            )}
          </div>
