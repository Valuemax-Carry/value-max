      ...
      <div className="vm-popup relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="px-6 py-5">
          ...
          <div className="space-y-3">
            <a href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(`Hi! I want to buy: ${buyProduct.name} (Rs. ${buyProduct.price?.toLocaleString()})`)}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 w-full bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold text-sm px-4 py-3 rounded-xl transition-colors duration-150">
